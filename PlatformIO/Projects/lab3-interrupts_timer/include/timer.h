...
/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM0_overflow_1ms() TCCR0B &= ~((1<<CS02) | (1<<CS00)); TCCR0B |= (1<<CS01);
/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM0_overflow_128us()    TCCR0B &= ~(1<<CS00); TCCR0B |= (1<<CS02) | (1<<CS01);
/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM0_overflow_16us()    TCCR0B &= ~(1<<CS01); TCCR0B |= (1<<CS02) | (1<<CS00);
